...
public class NotePlaybackThread extends Thread {
     ...
     * 
     * @param pool
     *            is the SoundPool used to play the samples
     * @param samples
     *            is the array of sample IDs
     * @param time
     *            is the Time containing the notes to play
     */
    public NotePlaybackThread(final SoundPool pool, final SampleMap samples,
            final Time time, Note[] tuning) {
        mPool = pool;
        mSamples = samples;
        mTime = time;
        mTuning = tuning;
     ...
     * 
     * @param time
     *            is the Time object containing the notes to play
     */
